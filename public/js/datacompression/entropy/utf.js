...
// Define input values for utf-8 exercise
let inputsUTF8 = [['00000000', '00000000', '00000000000000000000000000000000', '0'], ['11100010 10100101 10001010', '0000294A', '00000000000000000010100101001010', '244326400'], ['01011010', '0000005A', '00000000000000000000000001011010', '90'], ['11000100 10111111', '0000013F', '00000000000000000000000100111111', ]]
...
function displayUTF8(startingIndex) {
  randSign = Math.round(Math.random() * 10);
  // Save the indexes ot the signs to use them later to correct
  randSignListISOIEC.push(randSign);
  randSlot = Math.floor(Math.random() * 4);
  document.getElementById('UTF8extable' + (startingIndex + randSlot)).textContent = inputsISOIEC[randSign][randSlot];
}
...
function checkUTF8(message, index) {
  // If the input matches the solution display a green background
  if (message === inputsISOIEC[randNumListUTF8[Math.floor(index * 0.25)]][index % 4]) {
