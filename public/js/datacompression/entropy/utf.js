...
function displayASCII(startingIndex) {
  randSign = Math.round(Math.random() * 92);
...
function displayISOIEC(startingIndex) {
  randSign = Math.round(Math.random() * 186);
  // Save the indexes ot the signs to use them later to correct
